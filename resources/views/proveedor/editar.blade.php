...
<br>
    ...
    <form method="post" action="{{route('proveedor.edit',['id'=>$proveedor->id])}}">
        @method('put')
        @csrf
        <div class="form-group">
            <label for=" ">Nombre del Proveedor:</label>
            <input type="text" class="form-control" name="nombre_del_proveedor" id="nombre_del_proveedor" 
            placeholder="Ingrese el nombre del proveedor" value="{{$proveedor->nombre_del_proveedor}}">
        </div>
        ...
        <div class="form-group">
            ...
            placeholder="Ingrese el telefono" value="{{$proveedor->telefono}}">
        </div>
        ...
        <div class="form-group">
            ...
            placeholder="Ingrese el nombre del contacto del proveedor" value="{{$proveedor->nombre_del_contacto_proveedor}}">
        </div>
